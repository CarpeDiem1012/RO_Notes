 ...
 */
public class NewAVL<T extends Comparable<? super T>> {
    ...
    private void updateHeightAndBF(AVLNode<T> currentNode) {
        ...
        int heightL = left==null? -1 : left.getHeight();
        int heightR = right==null? -1 : right.getHeight();
        currentNode.setHeight(heightL > heightR? heightL+1 : heightR+1);
        currentNode.setBalanceFactor(heightL - heightR);
    }
